...
Java 25 is mandatory: kompot and petich publish variants tagged `org.gradle.jvm.version = 25`, and
Gradle refuses to build against them on anything lower.
...
2. [backlog.md](backlog.md) — the goal, the stages and the index. Items are one file each in
